...
impl ButtonScheme {
    pub fn to_string(&self) -> &'static str {
        match self {
            ...
            ButtonScheme::Custom => "focus:outline-none text-white bg-lpButton hover:bg-customGreen-600 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 cursor-pointer",
        }
    }
}
